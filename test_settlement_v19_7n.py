...
from paper_trader_v19_7n import (
...
import paper_trader_v19_7n as ptmod
init_src = inspect.getsource(ptmod)
assert_test('"blocked_candidates": 0' in init_src, "blocked_candidates in state template")
...
from paper_trader_v19_7n import PROFILES
...
from paper_trader_v19_7n import run_paper_cycle
