#!/usr/bin/env python3
"""V19.7k Paper Trading Engine — Profile-isolated readiness + scarcity diagnostics + dry-run expansion.
...
def fetch_clob_book(token_id):
    ...
    try:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "FDC-Paper/19.7k"})
