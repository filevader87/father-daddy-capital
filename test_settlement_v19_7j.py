...
from paper_trader_v19_7j import (
    ...
    EXECUTION_GATE_PASSED, LIVE_CONFIRMATION_FLAG,
...
def test_dry_run_broker():
    ...
    assert_test("would_execute" in result, "Dry-run result has would_execute")
    assert_test(not result["would_execute"], "Should NOT execute (MODE=PAPER)")
    ...
    assert_test(result["live_permission_state"]["MODE"] == "PAPER", "MODE is PAPER")
...
if __name__ == "__main__":
    print("=" * 60)
    print("V19.7j SETTLEMENT + MICRO-LIVE SAFETY TESTS")
    print("=" * 60)
