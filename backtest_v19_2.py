#!/usr/bin/env python3
"""
V19.2 Binance Backtest — Multi-Asset + 3-Zone Price Filter + Straddle Filter
==============================================================================
V19.1 + relaxed dead zone (20-50¢ blocked, 8-20¢ mid-zone w/ conf≥8)
"""
...
# Import V19.2 indicators directly
sys.path.insert(0, str(REPO))
